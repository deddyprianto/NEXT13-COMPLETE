export default function Sidebar() {
  return (
    <div class='h-full flex flex-col w-full px-4 py-8  bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700'>
      <a href='#'>
        <img
      ...
      <div class='flex flex-col justify-between flex-1 mt-6 bg-red-800'>
        <nav>
          <a
